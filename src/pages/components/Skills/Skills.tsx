...
function Skills() {
  return (
    <div id="skills" className="flex flex-col justify-center items-center p-5 mt-5 py-[30px]">
      <p className="text-3xl font-bold">Skills</p>
      <hr className="w-10 h-1 mx-auto my-2 bg-[#839788] border-0 rounded"/>
      <div className='grid grid-cols-4 gap-3 p-5'>
        <Skill title="JavaScript" subtitle="Application Development" image={javascript}/>
        <Skill title="Typescript" subtitle="Application Development" image={typescript}/>
      ...
      <Skill title="HTML 5" subtitle="Structural Design" image={html}/>
        ...
        <Skill title="Material UI" subtitle="Style Design" image={materialui}/>
        <Skill title="TailwindCSS" subtitle="Style Design" image={tailwindcss}/>
        <Skill title="MongoDB" subtitle="Database" image={mongo}/>
        <Skill title="Firebase" subtitle="Database" image={firebase}/>
        <Skill title="React Native" subtitle="Mobile Development" image={react}/>
        <Skill title="C#" subtitle="Software Development" image={csharp}/>
        <Skill title="Python" subtitle="Software Development" image={python}/>
      </div>
      <Github/>
    </div>
  )
